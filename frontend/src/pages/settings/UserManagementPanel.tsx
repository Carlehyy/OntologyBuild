      ...
      {view === 'accounts' ? (
        ...
        <section className="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            <div className="p-5">
              <div className="mb-4 flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3"><LockKeyhole size={16} className="mt-0.5 shrink-0 text-amber-700" /><div><p className="text-xs font-medium text-amber-900">系统设置不参与分配</p><p className="mt-0.5 text-[11px] leading-5 text-amber-700">用户、智能体和领域设置始终仅管理员可见与访问。</p></div></div>
