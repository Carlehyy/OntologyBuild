...
export default function OverviewPage() {
  ...
  const kpis: { label: string; value: string; suffix?: string; icon: React.ElementType; color: string; trend: string; trendTone?: DeltaTone; tag?: string; to?: string }[] = [
    ...
    { label: '待办审批', value: String(pendingApprovals), suffix: '', icon: CheckCircle2, color: '#d97706', trend: '-2', trendTone: 'good', tag: '待处理', to: '/data/pipelines/steward' },
