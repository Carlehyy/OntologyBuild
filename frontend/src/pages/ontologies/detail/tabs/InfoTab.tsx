    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border p-6">
        ...
        <dl className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
          <div className="flex items-center gap-2">
            <dt className="text-xs text-gray-500 whitespace-nowrap">{t('ontology.name')}</dt>
            <dd className="font-medium truncate">{ontology.name}</dd>
          </div>
          <div className="flex items-center gap-2">
            <dt className="text-xs text-gray-500 whitespace-nowrap">{t('ontology.domain')}</dt>
            <dd className="truncate">{ontology.domain}</dd>
          </div>
          <div className="flex items-center gap-2">
            <dt className="text-xs text-gray-500 whitespace-nowrap">{t('ontology.version')}</dt>
            <dd className="font-mono">{ontology.version}</dd>
          </div>
          <div className="flex items-center gap-2">
            <dt className="text-xs text-gray-500 whitespace-nowrap">{t('ontology.status')}</dt>
            <dd>{ontology.status}</dd>
          </div>
          <div className="col-span-2 flex items-center gap-2">
            <dt className="text-xs text-gray-500 whitespace-nowrap">构建方式</dt>
            <dd>
              {isPipelineMode
          ...
          {ontology.description && (
            <div className="col-span-2 flex items-start gap-2">
              <dt className="text-xs text-gray-500 whitespace-nowrap mt-0.5">{t('ontology.desc_optional')}</dt>
              <dd className="text-gray-700">{ontology.description}</dd>
            </div>
          )}
        </dl>
      </div>
