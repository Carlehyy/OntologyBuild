...
export default function ApiHubPage() {
  ...
  return (
    ...
    >
      {error && (
        <div role="alert" aria-live="assertive" className="absolute left-1/2 top-[42%] z-50 flex w-[min(560px,calc(100%-32px))] -translate-x-1/2 -translate-y-1/2 items-center justify-between rounded-xl border border-[#f2caca] bg-white/95 px-4 py-3 text-xs text-[var(--color-danger)] shadow-[0 18px 52px rgba(15,23,42,0.16)] backdrop-blur-xl animate-fade-in">
