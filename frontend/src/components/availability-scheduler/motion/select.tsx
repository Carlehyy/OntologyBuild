 ...
 * focus-visible:ring-foreground/20 → focus-visible:ring-ring（CSS 变量色不支持透明度修饰符，改用平台焦点环令牌）；
 * SelectValue 占位默认中文。
 */
...
export interface SelectProps {
   ...
   * positioned inside its field, so a layout that stacks selects has to know
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "hover:border-[var(--color-border-hover)] focus-visible:ring-2 focus-visible:ring-ring",
