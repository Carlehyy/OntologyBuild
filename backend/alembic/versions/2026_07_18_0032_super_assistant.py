...
def upgrade() -> None:
    ...
    if partial:
        ...
        # Early development builds could create the other Super Assistant
        # tables before MCP configuration was introduced.  This exact partial
        # state is safe to repair; later migrations add transport and built-in
        # server columns.
        if missing == {"super_assistant_mcp_servers"}:
